...
class DAPS_threshold:
    """
    Implements DAPS on top of a threshold conformal prediction class
    """
    # Code adapted from:
...
class DAPS:
    """
    Implements the diffusion adaptive score on top of an APS
    """
...
class K_Hop_DAPS:
    """
    Implements the k-hop neighbors diffusion score
    """
    def __init__(self, alpha, model, dataset, calibration_mask, seed,
